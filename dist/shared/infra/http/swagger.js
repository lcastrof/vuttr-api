...
var swaggerDocument = {
    swagger: '2.0',
    info: {
        description: 'Desafio da BossaBox de uma API para um repositório de ferramentas úteis',
        license: {
            name: 'MIT',
                ...
                parameters: [
                    {
                        name: 'id',
                        in: 'path',
                        description: "O id deve ser o uuid de uma ferramenta criada. Exemplos: 'b35865db-6aeb-43d9-ad75-916aee9a30fc' and '3385ce8a-61d6-423c-9c59-8430eaa03667'",
                        required: true,
                        type: 'string',
                    },
                ],
