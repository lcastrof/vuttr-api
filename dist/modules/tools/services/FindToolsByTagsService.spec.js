...
var FindToolsByTagsService_1 = __importDefault(require("./FindToolsByTagsService"));
var fakeToolsRepository;
var createTool;
var findToolsByTags;
describe('FindToolsByTags', function () {
    beforeEach(function () {
        fakeToolsRepository = new FakeToolsRepository_1.default();
        createTool = new CreateToolService_1.default(fakeToolsRepository);
        findToolsByTags = new FindToolsByTagsService_1.default(fakeToolsRepository);
    });
    it('should be able to find a tool passing a tag', function () { return __awaiter(void 0, void 0, void 0, function () {
        var tool, tool2, findTags;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    tool2 = _a.sent();
                    return [4 /*yield*/, findToolsByTags.execute('test3')];
                case 3:
                    findTags = _a.sent();
