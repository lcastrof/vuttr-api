...
describe('CreateTool', function () {
    ...
    it('should not be able to create two tools with the same title', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, createTool.execute({
                        title: 'title-test',
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, expect(createTool.execute({
                            title: 'title-test',
