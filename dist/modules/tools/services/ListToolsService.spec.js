...
var ListToolsService_1 = __importDefault(require("./ListToolsService"));
...
describe('ListTools', function () {
    beforeEach(function () {
        ...
        listTools = new ListToolsService_1.default(fakeToolsRepository);
    });
    it('should be able to list all the created tools', function () { return __awaiter(void 0, void 0, void 0, function () {
        var tool, tool2, tool3, list;
